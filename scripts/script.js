...
const { data, error } = await supabaseData.from('creatures').select(`
    id, name, power, ability, amount, boost, evolution, secondEvolution, thirdEvolution, place_octonite, tag_team, harmful_ability,
    set (
        name
    ),
    keywords (
...
$(".js_filter-btn").click(function() {
    ...
    let [boost, evolved, single, double, octonite, otherTagTeam, harmfulAbility, noAbility] = checkOther();
    ...
    array = getOther(array, boost, evolved, single, double, octonite, otherTagTeam, harmfulAbility, noAbility);
